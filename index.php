    ...
    <main>
        ...
        <section id="service" class="services-area pt-120 pb-50">
            <div class="container">
                ...
                $service_select_query = "SELECT * FROM services WHERE service_status = 'Active';";
                $service_final_query = mysqli_query($db_connect, $service_select_query); 
                ?>
                <div class="row">
                    <?php foreach($service_final_query as $service_item):?>                   
        ...
        <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
            <div class="container">
                ...
                <div class="row">
                    ...
                    $portfolio_final_query = mysqli_query($db_connect, $portfolio_select_query); 
                    ?>
                    <?php foreach($portfolio_final_query as $portfolio_item):?>
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/backend2/portfolio_photos/<?= $portfolio_item['portfolio_photo'];?>" alt="img">
                            </div>
                            <div class="speaker-overlay">
                                <span><?= $portfolio_item['portfolio_category']?></span>
                                <h4><a href="portfolio-single.html"><?= $portfolio_item['portfolio_title']?></a></h4>
        ...
        <section class="fact-area">
            <div class="container">
                <div class="fact-wrap">
                    <?php
                    $db_connect = mysqli_connect('localhost', 'root', '', 'portfolio');
                    $counter_select_query = "SELECT * FROM counters WHERE counter_status = 'Active';";
                    $counter_final_query = mysqli_query($db_connect, $counter_select_query); 
                    ?>
                    <div class="row justify-content-between">
                        <?php foreach($counter_final_query as $counter_item):?>
                        <div class="col-xl-2 col-lg-3 col-sm-6">
                            <div class="fact-box text-center mb-50">
                                <div class="fact-icon">
                                    <i class="<?= $counter_item['counter_icon']?>"></i>
                                </div>
                                <div class="fact-content">
                                    <h2><span class="count"><?= $counter_item['counter_number']?></span></h2>
                                    <span><?= $counter_item['counter_title']?></span>
                                </div>
                            </div>
                        </div>
                        <?php endforeach;?>
